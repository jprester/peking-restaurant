                ...
                <div id="jelovnik_content">
                    <table width="360" border="0" align="center" class="meni-table">
                        ...
                        <tr>
                            ...
                            <td width="268" class="td-jelo">
                                <strong>Kiselo - ljuta juha</strong><br />
                                Hot and sour soup
                            </td>
                            <td width="51" class="td-cijena">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="td-broj">2.</td>
                            <td class="td-jelo">
                                <strong>Proljetne rolade</strong><br />
                                Spring rolls
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="td-jelo">
                                <strong>Piletina ''Gombao'' (ljuto) (piletina, luk, mrkva, paprika, kikiriki)</strong><br />
                                Chicken ''Gombao'' style (hot) (chicken, onion, carrots, peppers, peanuts)
                            </td>
                            <td class="td-cijena">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="td-jelo">
                                <strong>Junetina s bambusom i kineskim gljivama</strong><br />
                        ...
                        <tr>
                            ...
                            <td class="td-jelo">
                                <strong>Pohane banane</strong><br />
                                Fried bananas
                            </td>
                            <td class="td-cijena">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <th colspan="3" class="table_naslov">Menu za 2 osobe P2 48,00</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="td-broj">3.</td>
                            <td class="td-jelo">
                                <strong>Hrskava patka sa slatko-kiselim umakom</strong><br />
                        ...
                        <tr>
                            <td class="td-broj">4.</td>
                            <td class="td-jelo">
                                <strong>Piletina sa povrćem</strong> (piletina, bambus, mrkva, šampinjoni, zelje)<br />
                        ...
                        <tr>
                            <td class="td-broj">6.</td>
                            <td class="td-jelo">
                                <strong>Pohani sladoled</strong><br />
                                Fried ice cream
                            </td>
                            <td>&nbsp;</td>
                        </tr>
